...
<div id="comments">
    ...
    <?php if ($this->allow('comment')): ?>
        <div id="<?php $this->respondId(); ?>" class="respond">
            ...
            <form method="post" action="<?php $this->commentUrl() ?>" id="comment-form" role="form">
                ...
                <?php else: ?>
                    <p>
                        <label for="author" class="required"><?php _e('用户名'); ?></label>
                    ...
                    <p>
                        <label
                            for="url"<?php if ($this->options->commentsRequireURL): ?> class="required"<?php endif; ?>><?php _e('你的网站'); ?></label>
                ...
                <p>
                    ...
                    <textarea rows="8" cols="50" name="text" id="textarea" class="textarea" placeholder="说点什么吧~"
    ...
    <?php else: ?>
        <h3 style="color:red;"><?php _e('评论被关闭了！'); ?></h3>
    <?php endif; ?>
</div>
